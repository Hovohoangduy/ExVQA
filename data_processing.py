...
train_dataset = PathVQA_dataset(train_data, transform=transforms)
val_dataset = PathVQA_dataset(val_data, transform=transforms)
test_dataset = PathVQA_dataset(test_data, transform=transforms)
